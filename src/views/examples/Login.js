...
import { resetPasswordEmail } from 'components/PDFAnnotate/utils'
...
class Login extends React.Component {
  ...
  componentDidMount() {
    ...
    forgotenterbtnnext.addEventListener('click', function (event) {
      ...
      var forgotenterpassword = document.getElementById('forgotenterpassword')
        .value
        ...
        axios
          .post('/api/sendmail', {
            ...
            body: resetPasswordEmail({
              URL: process.env.REACT_APP_BASE_URL + `/#/auth/login?resetlink=86hjw4ius&type=mail&u=` + forgotemail
            }),
