	...
	var email = document.getElementById('loginemail').value;
        ...
        .then(function (response) {
          ...
          if(response.data.Status === 'login successful'){
            ...
            setCookie('uid',response.data.UserID, 10);
            setCookie('useremail',response.data.UserEmail, 10);
