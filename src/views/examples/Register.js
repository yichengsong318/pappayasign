  ...
  componentDidMount() {
    ...
    function logUser(user) {
      ...
      if (user) {
        ...
        axios
        .post(''+'http://localhost:8080'+'/registerapi', {
            UserID: userid,
