...
AddtoDocBtn.addEventListener("click", function (event) {
	...
	if(userid){
		console.log(userid);
			...
			var storageRef = firebase.storage().ref(userid + '/Signature/'+filename+'.png');
			...
			console.log('started')
				...
				//firebase.database().ref('Users/'+userid).child('SignID').set(signid);
        ...
        <Container className="mt--7">
          ...
          >
            ...
            <TabContent activeTab={"tabs" + this.state.tabs} id="tabcontent">
              <TabPane tabId="tabs1">
			  <div id="signatureview2" className="mdl-dialog mb-3 col-lg-12 col-md-12" >
				...
				<div>
					<Button className="m-2 float-right" color="neutral" type="button" data-action="clear2">Clear</Button>

				</div>
				<div>
				<Button className="m-2" id="addtodoc2" color="primary" type="button" data-action="add-to-doc2">Save and Continue</Button>
				</div>
					</div>
				</div>
				</div>
