      ...
      UserID: userid
       ...
       if(response.data.Status === 'user found'){
         ...
         Request.forEach(function(data, index){
            if( Request[index].RecepientStatus == 'Void' || Request[index].RecepientStatus == 'Need to Sign' || Request[index].RecepientStatus == 'Correcting'){

                allcontent +='<tr >';
              allcontent +='<th><input  type="checkbox"></th>';
              allcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+Request[index].DocumentName+ '\nFrom: '+Request[index].FromEmail+'</span></td>';
              allcontent += '<td id="datastatus">' + Request[index].RecepientStatus + '</td>';
              allcontent += '<td id="datakey" hidden>' + Request[index].DocumentID + '</td>';
              allcontent += '<td id="datauid" hidden>' + Request[index].From + '</td>';
              allcontent += '<td id="datarecep" hidden>' + Request[index].FromEmail + '</td>';
              allcontent += '<td >' + Request[index].RecepientDateStatus + '</td>';
              allcontent+=`<td ><div class="btn-group">
              <button type="button" class="btn btn-primary"><a href="#/admin/sign?id=`+Request[index].DocumentID+`&type=db&u=`+Request[index].From+`">SIGN</a></button>
              ...
              if(Request[index].RecepientStatus == 'Need to Sign'){
                ...
                actionrequiredcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+Request[index].DocumentName+ '\nFrom: '+data.FromEmail+'</span></td>';
                actionrequiredcontent += '<td id="datastatus">' + Request[index].RecepientStatus + '</td>';
                actionrequiredcontent += '<td id="datakey" hidden>' + Request[index].DocumentID + '</td>';
                actionrequiredcontent += '<td id="datauid" hidden>' + Request[index].From + '</td>';
                actionrequiredcontent += '<td id="datarecep" hidden>' + Request[index].FromEmail + '</td>';
                actionrequiredcontent += '<td >' + Request[index].RecepientDateStatus + '</td>';
            ...
            deletedcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+Request[index].DocumentName+ '\nFrom: '+Request[index].FromEmail+'</span></td>';
            deletedcontent += '<td id=datastatus>' + Request[index].RecepientStatus + '</td>';
            deletedcontent += '<td id="datakey" hidden>' + Request[index].DocumentID + '</td>';
            deletedcontent += '<td id="datauid" hidden>' + Request[index].From + '</td>';
            deletedcontent += '<td id="datarecep" hidden>' + Request[index].FromEmail + '</td>';
            deletedcontent += '<td >' + Request[index].RecepientDateStatus + '</td>';
            ...
            completedcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+Request[index].DocumentName+ '\nFrom: '+Request[index].FromEmail+'</span></td>';
            completedcontent += '<td id="datastatus">' + Request[index].RecepientStatus + '</td>';
            completedcontent += '<td id="datakey" hidden>' + Request[index].DocumentID + '</td>';
            completedcontent += '<td id="datauid" hidden>' + Request[index].From + '</td>';
            completedcontent += '<td id="datarecep" hidden>' + Request[index].FromEmail + '</td>';
            completedcontent += '<td >' + Request[index].RecepientDateStatus + '</td>';
      ...
      UserID: userid
       ...
       if(response.data.Status === 'doc found'){
        ...
        Documents.forEach(function(data, index){
          ...
          if(data.Status == 'Sent' || data.Status == 'Waiting for Others' || data.Status == 'Declined' || data.Status == 'Void' || data.Status == 'Authentication Failed' || data.Status == 'Correcting' ||  data.Status == 'Completed' ||  data.Status == 'Draft'){
            if(data.Status == 'Waiting for Others'){
              waitingcontent +='<tr >';
              waitingcontent +='<th><input  type="checkbox"></th>';
              waitingcontent +='<td scope="row" class="rowselect" ><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
              waitingcontent += '<td id=datastatus>' + data.Status + '</td>';
              waitingcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
              waitingcontent += '<td id="datarecep" hidden>' + reciverlist + '</td>';
              waitingcontent += '<td id="datauid" hidden>' + data.Owner + '</td>';
            ...
            sentcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
            sentcontent += '<td id=datastatus>' + data.Status + '</td>';
            sentcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
            ...
            sentcontent += '</tr>';
              ...
              draftcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
              draftcontent += '<td id=datastatus>' + data.Status + '</td>';
              draftcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
              draftcontent += '<td id="datarecep" hidden>' + reciverlist + '</td>';
              draftcontent += '<td id="datauid" hidden>' + data.Owner + '</td>';
            ...
            draftcontent += '</tr>';
              ...
              authcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
              authcontent += '<td id=datastatus>' + data.Status + '</td>';
              authcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
              authcontent += '<td id="datarecep" hidden>' + reciverlist + '</td>';
              authcontent += '<td id="datauid" hidden>' + data.Owner + '</td>';
            ...
            sentcontent += '</tr>';
              ...
              expiringcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
              expiringcontent += '<td id=datastatus>' + data.Status + '</td>';
              expiringcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
              expiringcontent += '<td id="datarecep" hidden>' + reciverlist + '</td>';
              expiringcontent += '<td id="datauid" hidden>' + data.Owner + '</td>';
            ...
            sentcontent += '</tr>';
              ...
              completedcontent +='<tr >';
              completedcontent +='<th><input  type="checkbox"></th>';
              completedcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
              completedcontent += '<td id=datastatus>' + data.Status + '</td>';
              completedcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
              completedcontent += '<td id="datarecep" hidden>' + reciverlist + '</td>';
              completedcontent += '<td id="datauid" hidden>' + data.Owner + '</td>';
            ...
            deletedcontent +='<tr >';
              deletedcontent +='<th><input  type="checkbox"></th>';
              deletedcontent +='<td scope="row" class="rowselect"><span className="mb-0 text-sm">'+data.DocumentName+ '\nTo: '+reciverlist+'</span></td>';
              deletedcontent += '<td id=datastatus>' + data.Status + '</td>';
              deletedcontent += '<td id="datakey" hidden>' + data.DocumentID + '</td>';
              deletedcontent += '<td id="datarecep" hidden>' + reciverlist + '</td>';
              deletedcontent += '<td id="datauid" hidden>' + data.Owner + '</td>';
      ...
      DocumentID: rowselectfileid
       ...
       if(response.data.Status === 'doc data done'){
        ...
        var reciverlistrow = '';
            ...
            document.getElementById('detailsent').innerHTML = Document.DateSent;
            document.getElementById('detailcreate').innerHTML = Document.DateCreated;
            document.getElementById('detailholder').innerHTML = Document.OwnerEmail;
            document.getElementById('detailrecepients').innerHTML = reciverlistrow;
            document.getElementById('detailstatus').innerHTML = Document.Status;
            document.getElementById('detailstatusdate').innerHTML = Document.DateStatus;
            ...
            recievers.forEach(function(item, index) {
              ...
              axios.post('/getRequests', {
                ...
                axios.post('/sendmail', {
                  ...
                  body: '<div><p>Hello '+item.RecepientName+', '+item.DocumentName+' Has been voided. \n\nReason:'+managevoidmessage+'</p></div>',
    ...
    axios.post('/getdocdata', {
      DocumentID: fileid
       ...
       if(response.data.Status === 'doc data done'){
         ...
         var datarray = [];
          datarray.push({DateCreated: Document.DateCreated, DateSent: Document.DateSent, DateCreated:Document.DateCreated , DateStatus: Document.DateStatus, DocumentName: Document.DocumentName, Owmer:Document.Owner , OwnerEmail: Document.OwnerEmail,  Recepients: recepients, Status: Document.Status });
    ...
    axios.post('/getReciever', {
      ...
      if(response.data.Status === 'got recievers'){
        ...
        recievers.forEach(function(item, index) {
          ...
          dbpeople.push({name: item.RecepientName, email: item.RecepientEmail, option:item.RecepientOption});
