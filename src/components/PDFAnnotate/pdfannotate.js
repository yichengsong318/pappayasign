...
import './styles.css'
import { getColorFromHex, randomString, getGeoInfo, signRequestEMail, signCompletedEmail } from './utils'
                    ...
                    .catch(function (error) {
                      ...
                      axios
                        .post('/api/sendmailattachments', {
                          ...
                          body: signCompletedEmail({DocumentName: inst.filename + '.pdf', URL: '#'}),
                          subject:
                            'GEMS: ' +
                            inst.filename +
                            ' :Completed Document',
                          ...
                          if (completedcount == recievercount) {
                            ...
                            axios
                              .post('/api/sendmailattachments', {
                                to: OwnerEmail,
                                //body:'<div><p>Hello , Please find the signed document in the attachment.</p></div>',
                                body: signCompletedEmail({DocumentName: documentname, URL: '#'}),
                                subject:
                                  'GEMS: ' +
                                  documentname +
                                  ' :Completed Document',
                              ...
                              try {
                                ...
                                axios
                                  .post('/api/sendmail', {
                                    ...
                                    body: signRequestEMail({Name: nextuseremail, DocumentName: documentname, URL: nextuserurl}),
