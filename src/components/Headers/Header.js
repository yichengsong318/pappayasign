...
class Header extends React.Component {
  ...
  componentDidMount() {
            ...
            if (response.data.Status === 'user found') {
              if (response.data.user.SignID != '') {
                ...
                if (response.data.user.ProfileImage) {
                  ...
                  profileimg.src = response.data.user.ProfileImage
                }
    ...
    function SignaturePad() {
      ...
      AddtoDocBtn.addEventListener('click', function (event) {
        if (signaturePad.isEmpty()) {
          ...
          document.getElementById('signaturetextspan').innerHTML = 'Please Wait'
          ...
          axios
            ...
            .then(function (response) {
              if (response.data === 'signed') {
                ...
                document.getElementById('signaturetextspan').innerHTML = ''
                signimg.src = dataURL
              }
            })
            .catch(function (error) {})
    ...
    var homesigncancelbtn = document.getElementById('homesigncancelbtn')
    homesigncancelbtn.addEventListener('click', function (event) {
      modal[0].style.display = 'none'
    })
                      ...
                      <TabPane tabId="tabs1">
                        ...
                        >
                          <div className="card-body p-0">
                            <div id="signature-pad2" className="signature-pad2">
                              ...
                              <div className="text-muted font-bold justify-content-right my-3 float-right">
                                <small>
                                  <span
                                    id="signaturetextspan"
                                    className="text-dark font-weight-700 font-size-12 justify-content-right float-right"
                                  ></span>
                                </small>
                              </div>
                            </div>
                ...
                >
                  ...
                  <a id="homesignimgbtn">
                    <div className="float-center homesigncontainer">
                      ...
                      <p id="homesignid" className="float-left signid">
                        WF2D2522ADBFD
                      </p>
                    </div>
                  </a>
