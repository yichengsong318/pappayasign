...
document.getElementById("trecepientselect")
	.addEventListener("change", function () {
		...
		recepientcolor =
			...
			if(recepientcolor != 'rgb(189, 189, 189)'){
				document.getElementById("templatedragabbleImageSign").style.backgroundColor = recepientcolor;
				document.getElementById("templatedragabbleImageText").style.backgroundColor = recepientcolor;
	...
	document.addEventListener("mousemove", function (e) {
		$("#templatedragabbleImageSign").css({ left: e.clientX - 200, top: e.clientY - 70 });
		$("#templatedragabbleImageText").css({ left: e.clientX - 40, top: e.clientY - 40 });
	});
...
render() {
	...
	<button id="tzoominbtn" color="neutral" className="toolzoom"><i className="material-icons" >zoom_in</i></button>
	<button id="tzoomoutbtn" color="neutral" className="toolzoom"><i className="material-icons" >zoom_out</i></button>
