	...
	return (function(e) {
		...
		function(e, t, r) {
			...
			var n = r(1),
				...
				l = r(185);
			if (r(4)()) {
				var h = r(197).PDFNodeStream;
				i.setPDFNetworkStreamFactory(function(e) {
					return new h(e);
				});
			} else {
				var f,
					d = r(200).PDFNetworkStream;
				s.isFetchSupported() && (f = r(201).PDFFetchStream),
					i.setPDFNetworkStreamFactory(function(e) {
						return f && s.isValidFetchUrl(e.url)
							? new f(e)
							: new d(e);
					});
			}
		...
		function(e, t, r) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				...
				(t.info = function(e) {
					f >= h.INFOS && console.log('Info: '.concat(e));
				}),
				...
				(t.isSameOrigin = function(e, t) {
					var r;
					try {
						if (!(r = new URL(e)).origin || 'null' === r.origin)
							return !1;
					} catch (e) {
						return !1;
					}
			...
			var f = h.WARNINGS;
			function d(e) {
				f >= h.WARNINGS && console.log('Warning: '.concat(e));
			}
			function p(e) {
				throw new Error(e);
			}
			...
			var g = (function() {
				function e(t) {
					this.constructor === e &&
						p('Cannot initialize BaseException.'),
						(this.message = t),
			...
			var m = (function(e) {
				function t(e, r) {
					...
					return (
						o(this, t),
						((n = s(this, u(t).call(this, e))).code = r),
						n
					);
				}
				return c(t, e), t;
			...
			var y = (function(e) {
				function t(e, r) {
					...
					return (
						o(this, t),
						((n = s(this, u(t).call(this, e))).details = r),
						n
					);
				}
				return c(t, e), t;
			...
			t.MissingPDFException = _;
			var A = (function(e) {
				function t(e, r) {
					var n;
					return (
						o(this, t),
						((n = s(this, u(t).call(this, e))).status = r),
						n
					);
				}
				return c(t, e), t;
			})(g);
			t.UnexpectedResponseException = A;
			var S = (function(e) {
				function t() {
					return o(this, t), s(this, u(t).apply(this, arguments));
				}
			...
			var k = /\x00/g;
			function x(e) {
				v('string' == typeof e, 'Invalid argument for stringToBytes');
			...
			function C(e) {
				return void 0 !== e.length
					? e.length
					: (v(void 0 !== e.byteLength), e.byteLength);
			}
			var P = ['rgb(', 0, ',', 0, ',', 0, ')'],
				R = (function() {
					function e() {
					...
					for (l in t) {
						if (
							...
							(h = e.noTargetGet
								? (d = i(r, l)) && d.value
								: r[l]),
							!c(v ? l : p + (g ? '.' : '#') + l, e.forced) &&
								void 0 !== h)
						) {
							if (typeof f == typeof h) continue;
							u(f, h);
						}
						(e.sham || (h && h.sham)) && a(f, 'sham', !0),
							o(r, l, f, e);
					}
			};
		},
		...
		function(e, t, r) {
			...
			var n = r(7),
				...
				a = r(17);
			n(
				{ target: 'String', proto: !0, forced: !r(53)('includes') },
				{
					includes: function(e) {
			...
			e.exports = function(e, t, r, l, d, y, b) {
				...
				if (
					...
					if (
						...
						for (S in A) (!v && !x && S in C) || c(C, S, A[S]);
		...
		function(e, t, r) {
			...
			e.exports = function(e) {
				...
				if (
					...
					for (r = new d((t = s(f.length))); t > m; m++)
						u(r, m, g ? v(f[m], m) : f[m]);
				else
			...
			e.exports =
				...
				i(function() {
					...
					return (
						...
						7 != l({}, e)[r] ||
							'abcdefghijklmnopqrst' != a(l({}, t)).join('')
					);
				})
					? function(e, t) {
							for (
		...
		function(e, t, r) {
			r(7)({ target: 'Number', stat: !0 }, { isInteger: r(98) });
		},
		function(e, t, r) {
			var n = r(19),
				i = Math.floor;
		...
		function(e, t, r) {
					...
					Y
						...
						(i = c['on' + e])
							...
							: 'unhandledrejection' === e &&
							  C('Unhandled promise rejection', r);
				},
				$ = function(e, t) {
					w.call(c, function() {
						var r,
			...
			V &&
				...
				u ||
					...
					'function' == typeof W &&
						s(
							...
							{
								fetch: function(e) {
									return x(N, W.apply(c, arguments));
								},
							},
						))),
				s({ global: !0, wrap: !0, forced: V }, { Promise: N }),
				p(N, F, !1, !0),
				v(F),
				(a = l.Promise),
				s(
				...
				s(
					{ target: F, stat: !0, forced: u || V },
					{
						resolve: function(e) {
							return x(u && this === a ? N : this, e);
						},
					},
				),
				s(
		...
		function(e, t, r) {
			...
			(e.exports = function(e, t, r, l, h) {
				...
				for (; !(m = f.next()).done; )
					if ((g = u(f, y, m.value, l)) && g instanceof c) return g;
				return new c(!1);
			}).stop = function(e) {
				return new c(!0, e);
			};
		...
		function(e, t, r) {
			...
			(d && p) ||
				...
				'process' == u(v)
					...
					: ((n = w), o.addEventListener('message', S, !1))),
		...
		function(e, t, r) {
			...
			var n,
				...
				N = function(e, t) {
					...
					if ('[' == t.charAt(0)) {
						...
						if (((t = v(t)), F.test(t))) return 'Invalid host';
						if (null === (r = D(t))) return 'Invalid host';
						e.host = r;
					} else {
						if (I.test(t)) return 'Invalid host';
						for (r = '', n = d(t), i = 0; i < n.length; i++)
							r += H(n[i], W);
						e.host = r;
					}
				},
				...
				Se = function(e) {
					var t,
						...
						s = S(n, { type: 'URL' });
					if (void 0 !== i)
						if (i instanceof Se) t = w(i);
						else if ((r = Ae((t = {}), String(i))))
							throw TypeError(r);
					...
					c.updateSearchParams(s.query),
						...
						a ||
							((n.href = ke.call(n)),
							(n.origin = xe.call(n)),
							(n.protocol = Ce.call(n)),
							(n.username = Pe.call(n)),
							(n.password = Re.call(n)),
							(n.host = Te.call(n)),
							(n.hostname = Ee.call(n)),
							(n.port = Oe.call(n)),
							(n.pathname = Le.call(n)),
							(n.search = Fe.call(n)),
				...
				(a &&
					u(we, {
						...
						host: Me(Te, function(e) {
							var t = w(this);
							t.cannotBeABaseURL || Ae(t, String(e), le);
						}),
						hostname: Me(Ee, function(e) {
							var t = w(this);
							t.cannotBeABaseURL || Ae(t, String(e), he);
						}),
						port: Me(Oe, function(e) {
							var t = w(this);
							Q(t) ||
								('' == (e = String(e))
									? (t.port = null)
						...
						pathname: Me(Le, function(e) {
							var t = w(this);
							t.cannotBeABaseURL ||
								((t.path = []), Ae(t, e + '', ge));
						}),
						search: Me(Fe, function(e) {
							var t = w(this);
							'' == (e = String(e))
								? (t.query = null)
			...
			g(Se, 'URL'), i({ global: !0, forced: !o, sham: !a }, { URL: Se });
		},
		function(e, t, r) {
			var n = r(11),
				i = r(51),
		...
		function(e, t, r) {
			...
			e.exports = function(e) {
				...
				for (t = 0; t < o.length; t++)
					(r = o[t]), a.push(n.test(r) ? 'xn--' + l(r) : r);
				return a.join('.');
			};
		},
		function(e, t, r) {
			...
			var n = r(7),
				...
				T = function(e) {
					return encodeURIComponent(e).replace(C, R);
				},
				E = function(e, t) {
					if (t)
				...
				O = function(e) {
					(this.entries.length = 0), E(this.entries, e);
				},
				L = function(e, t) {
			...
			o(
				j,
				{
					...
					delete: function(e) {
						...
						for (
							var t = b(this), r = t.entries, n = e + '', i = 0;
							i < r.length;
					...
					getAll: function(e) {
						L(arguments.length, 1);
						for (
							var t = b(this).entries, r = e + '', n = [], i = 0;
							i < t.length;
							i++
						)
				...
				s(I, 'URLSearchParams'),
				n({ global: !0, forced: !i }, { URLSearchParams: I }),
				(e.exports = { URLSearchParams: I, getState: b });
		},
		function(e, t, r) {
			var n = r(25),
				i = r(86);
		...
		function(e, t, r) {
			var n = r(35),
				...
				d = (e.exports = {
					...
					onFreeze: function(e) {
						return u && d.REQUIRED && h(e) && !a(e, c) && f(e), e;
					},
				});
			n[c] = !0;
		},
			...
			n(
				{ target: 'String', stat: !0, forced: !!o && 1 != o.length },
				{
					fromCodePoint: function(e) {
						for (
							var t, r = [], n = arguments.length, o = 0;
							n > o;
				...
				{ target: 'Array', proto: !0, forced: !d || !p },
				{
					concat: function(e) {
						...
						for (t = -1, n = arguments.length; t < n; t++)
							if (((a = -1 === t ? o : arguments[t]), v(a))) {
								if (f + (i = u(a.length)) > 9007199254740991)
									throw TypeError(
			...
			var n = r(7),
				...
				re =
					...
					u(function() {
						...
						: X,
				ne = function(e, t) {
					var r = (Q[e] = m(B.prototype));
					return (
						q(r, { type: 'Symbol', tag: e, description: t }),
						o || (r.description = t),
						r
					);
				},
			...
			s ||
				(C(
					(B = function() {
						...
						return (
							o && te && re(W, t, { configurable: !0, set: r }),
							ne(t, e)
						);
					}).prototype,
					'toString',
				...
				o &&
					...
					a || C(W, 'propertyIsEnumerable', se, { unsafe: !0 })),
				(L.f = function(e) {
					return ne(O(e), e);
				})),
				n(
				...
				B.prototype[D] || x(B.prototype, D, B.prototype.valueOf),
				I(B, 'Symbol'),
				(T[N] = !0);
		},
		function(e, t, r) {
				...
				s = function(e) {
					return function(t, r, s) {
						...
						return d <= h || '' == f
							? l
							: ((u = d - h),
							  (c = i.call(f, o(u / f.length))).length > u &&
									(c = c.slice(0, u)),
							  e ? l + c : c + l);
					};
				};
		...
		function(e, t, r) {
			...
			t.ReadableStream = n ? ReadableStream : r(178).ReadableStream;
		},
		function(e, t, r) {
			'use strict';
			r.r(t),
					...
					(e.prototype.forEach = function(e) {
						for (
							...
							!(
								...
								(t === n.length &&
									((t = 0),
									0 === (n = (r = r._next)._elements).length))
							);
			...
			function E(e, t, r) {
				var n = e._reader;
				n._readRequests.shift()._resolve(m(t, r, n._forAuthorCode));
			}
			function O(e) {
			...
			var F,
				...
				j = (function() {
					function e(e) {
						...
						y(this, e), (this._readRequests = new g());
					}
					return (
						...
						(e.prototype.read = function() {
							return M(this)
								? void 0 === this._ownerReadableStream
									...
									: N(this)
								: Promise.reject(D('read'));
						}),
						(e.prototype.releaseLock = function() {
							if (!M(this)) throw D('releaseLock');
			...
			'symbol' == typeof n.asyncIterator &&
				(((F = {})[n.asyncIterator] = function() {
					return this;
				}),
				(I = F),
				Object.defineProperty(I, n.asyncIterator, { enumerable: !1 }));
			var q = {
				next: function() {
					if (!1 === U(this)) return Promise.reject(W('next'));
					var e = this._asyncIteratorReader;
					return void 0 === e._ownerReadableStream
						? Promise.reject(A('iterate'))
						: N(e).then(function(t) {
								var r = t.done;
								return r && _(e), m(t.value, r, !0);
						  });
				},
				return: function(e) {
					if (!1 === U(this)) return Promise.reject(W('next'));
			...
			void 0 !== I && Object.setPrototypeOf(q, I),
				Object.defineProperty(q, 'next', { enumerable: !1 }),
				Object.defineProperty(q, 'return', { enumerable: !1 });
			var B = i;
			function z(e) {
				...
				V = (function() {
					...
					return (
						...
						(e.prototype.getWriter = function() {
							if (!1 === J(this)) throw Ae('getWriter');
							return Q(this);
						}),
						e
					);
			...
			function $(e, t) {
				...
				return (
					(e._pendingAbortRequest._promise = i),
					!1 === n && te(e, t),
					i
				);
			}
			function ee(e, t) {
				'writable' !== e._state ? re(e) : te(e, t);
			}
			function te(e, t) {
			...
			function re(e) {
				(e._state = 'errored'), e._writableStreamController[Y]();
				...
				if (
					...
					if (
						...
						return r._reject(t), void ie(e);
					e._writableStreamController[X](r._reason).then(
						function() {
							r._resolve(), ie(e);
						},
						function(t) {
			...
			var oe = (function() {
				function e(e) {
					...
					var t,
						r = e._state;
					if ('writable' === r)
						!1 === ne(e) && !0 === e._backpressure
							? Re(this)
							: Ee(this),
							ke(this);
					else if ('erroring' === r)
						Te(this, e._storedError), ke(this);
					else if ('closed' === r) Ee(this), ke((t = this)), Pe(t);
					else {
				...
				return (
					...
					(e.prototype.abort = function(e) {
						return !1 === se(this)
							? Promise.reject(Se('abort'))
							: void 0 === this._ownerWritableStream
							? Promise.reject(we('abort'))
							: (function(e, t) {
									return $(e._ownerWritableStream, t);
							  })(this, e);
					}),
					(e.prototype.close = function() {
						if (!1 === se(this)) return Promise.reject(Se('close'));
						var e = this._ownerWritableStream;
						return void 0 === e
							? Promise.reject(we('close'))
							: !0 === ne(e)
							? Promise.reject(
									new TypeError(
					...
					(e.prototype.releaseLock = function() {
						if (!1 === se(this)) throw Se('releaseLock');
						void 0 !== this._ownerWritableStream && he(this);
					}),
					(e.prototype.write = function(e) {
						return !1 === se(this)
							? Promise.reject(Se('write'))
							: void 0 === this._ownerWritableStream
							? Promise.reject(we('write to'))
							: fe(this, e);
					}),
					e
				);
			...
			function ue(e) {
				...
				return (
					!0 === t._backpressure && 'writable' === r && Le(e),
					G((n = t._writableStreamController), 'close', 0),
					me(n),
					i
				);
			}
			...
			function fe(e, t) {
				...
				if (r !== e._ownerWritableStream)
					return Promise.reject(we('write to'));
				var a = r._state;
										...
										ve(e),
											r
												.then(
													function() {
														!(function(e) {
															e._inFlightCloseRequest._resolve(
																void 0,
															),
																(e._inFlightCloseRequest = void 0),
																'erroring' ===
			...
			function ye(e, t) {
				'writable' === e._controlledWritableStream._state && _e(e, t);
			}
			function be(e) {
				return ge(e) <= 0;
			}
			...
			function Fe(e, t, r, n, a, o) {
				...
				return new Promise(function(h, f) {
					...
					if (
						(b(e, s._closedPromise, function(e) {
							!1 === n
								? A(
										function() {
											return $(t, e);
						...
						b(t, u._closedPromise, function(t) {
							!1 === a
								? A(
										function() {
											return xt(e, t);
						...
						'closed' === p._state ? g() : v.then(g).catch(B),
						!0 === ne(t) || 'closed' === t._state)
					) {
						var m = new TypeError(
					...
					function w(e, t) {
						he(u),
							_(s),
							void 0 !== o && o.removeEventListener('abort', d),
							e ? f(t) : h(void 0);
					}
			...
			var Ie = (function() {
				...
				return (
					Object.defineProperty(e.prototype, 'desiredSize', {
						get: function() {
							if (!1 === je(this)) throw He('desiredSize');
							return Be(this);
						},
						enumerable: !0,
						configurable: !0,
						...
						if (this._queue.length > 0) {
							...
							return (
								...
								0 === this._queue.length
									...
									: Me(this),
								Promise.resolve(
									m(t, !1, e._reader._forAuthorCode),
								)
							);
						}
						var r = T(e);
			...
			function qe(e) {
				var t = e._controlledReadableStream;
				(e._closeRequested = !0),
					0 === e._queue.length && (De(e), Ct(t));
			}
			function Ue(e, t) {
				var r = e._controlledReadableStream;
				if (!0 === kt(r) && O(r) > 0) E(r, t, !1);
				else {
					var n = void 0;
					try {
			...
			function We(e, t) {
				var r = e._controlledReadableStream;
				'readable' === r._state && (H(e), De(e), Pt(r, t));
			}
			function Be(e) {
						...
						(e.prototype.respondWithNewView = function(e) {
							...
							e.buffer,
								(function(e, t) {
									...
									(r.buffer = t.buffer), ot(e, t.byteLength);
								})(
									this
										._associatedReadableByteStreamController,
									e,
				...
				Ve = (function() {
					...
					return (
						Object.defineProperty(e.prototype, 'byobRequest', {
							get: function() {
								if (!1 === Qe(this)) throw dt('byobRequest');
								if (
						...
						Object.defineProperty(e.prototype, 'desiredSize', {
							get: function() {
								if (!1 === Qe(this)) throw dt('desiredSize');
								return lt(this);
							},
							enumerable: !0,
							configurable: !0,
						...
						(e.prototype.close = function() {
							...
							!(function(e) {
								...
								if (e._pendingPullIntos.length > 0) {
									if (
										e._pendingPullIntos.peek().bytesFilled >
										0
									) {
										var r = new TypeError(
						...
						(e.prototype[P] = function() {
							...
							if (this._queueTotalSize > 0) {
								...
								return Promise.resolve(
									m(r, !1, e._reader._forAuthorCode),
								);
							}
			...
			function Ze(e, t) {
				...
				'default' === t.readerType
					...
					: (function(e, t, r) {
							...
							n._readIntoRequests
								.shift()
								._resolve(m(t, r, n._forAuthorCode));
					  })(e, n, r);
			}
			function $e(e) {
				var t = e.bytesFilled,
			...
			function tt(e, t) {
				...
				for (var c, l, h, f, d, p = e._queue; s > 0; ) {
					var v = p.peek(),
						g = Math.min(s, v.byteLength),
						m = t.byteOffset + t.bytesFilled;
					(c = t.buffer),
						(l = m),
						(h = v.buffer),
						(f = v.byteOffset),
						(d = g),
						new Uint8Array(c).set(new Uint8Array(h, f, d), l),
						v.byteLength === g
							? p.shift()
							: ((v.byteOffset += g), (v.byteLength -= g)),
						(e._queueTotalSize -= g),
						rt(e, g, t),
						(s -= g);
				}
			...
			function rt(e, t, r) {
				it(e), (r.bytesFilled += t);
			}
			function nt(e) {
				0 === e._queueTotalSize && !0 === e._closeRequested
					? (ut(e), Ct(e._controlledReadableByteStream))
					: Je(e);
			}
			function it(e) {
			...
			function at(e) {
				for (; e._pendingPullIntos.length > 0; ) {
					...
					!0 === tt(e, t) &&
						(st(e), Ze(e._controlledReadableByteStream, t));
				}
			}
			function ot(e, t) {
				var r = e._pendingPullIntos.peek();
			...
			function ct(e, t) {
				...
				'readable' === r._state &&
					(!(function(e) {
						it(e), (e._pendingPullIntos = new g());
					})(e),
					H(e),
					ut(e),
					Pt(r, t));
			...
			function ht(e, t, r) {
				...
				var i = l(t, 'pull', 0, [n]),
					a = l(t, 'cancel', 1, []),
					o = t.autoAllocateChunkSize;
				if (void 0 !== o && ((o = Number(o)), !1 === Xe(o) || o <= 0))
					throw new RangeError(
			...
			var mt = (function() {
				function e(e) {
					...
					if (!1 === Qe(e._readableStreamController))
						throw new TypeError(
					...
					y(this, e), (this._readIntoRequests = new g());
				}
				return (
					Object.defineProperty(e.prototype, 'closed', {
						get: function() {
					...
					(e.prototype.read = function(e) {
						return yt(this)
							...
							: Promise.reject(bt('read'));
					}),
					(e.prototype.releaseLock = function() {
						if (!yt(this)) throw bt('releaseLock');
						if (void 0 !== this._ownerReadableStream) {
			...
			var _t = (function() {
				...
				return (
					...
					(e.prototype.getReader = function(e) {
						...
						if (!1 === wt(this)) throw Tt('getReader');
					...
					(e.prototype.pipeThrough = function(e, t) {
						var r = e.writable,
							...
							u = a.preventCancel,
							c = a.signal;
						if (!1 === wt(this)) throw Tt('pipeThrough');
						if (!1 === J(r))
							throw new TypeError(
						...
						return Fe(this, r, o, s, u, c).catch(i), n;
					}),
					...
					(e.prototype.tee = function() {
						...
						var e = (function(e, t) {
											...
											.then(function(e) {
												if (((c = !1), !0 === e.done))
													return (
														!1 === l &&
															qe(
																i._readableStreamController,
															),
														void (
															!1 === h &&
															qe(
																a._readableStreamController,
															)
														)
													);
												var t = e.value,
							...
							return (
								...
								u._closedPromise.catch(function(e) {
									We(i._readableStreamController, e),
										We(a._readableStreamController, e);
								}),
								[i, a]
							);
						})(this);
					...
					(e.prototype.getIterator = function(e) {
						var t = (void 0 === e ? {} : e).preventCancel,
							r = void 0 !== t && t;
						if (!1 === wt(this)) throw Tt('getIterator');
						return (function(e, t) {
							void 0 === t && (t = !1);
							var r = R(e),
								n = Object.create(q);
			...
			function At(e, t, r, n, i) {
				...
				var a = Object.create(_t.prototype);
				return (
					St(a), Ge(a, Object.create(Ie.prototype), e, t, r, n, i), a
				);
			}
			function St(e) {
				(e._state = 'readable'),
			...
			function xt(e, t) {
				return (
					...
					'closed' === e._state
						...
						: (Ct(e),
						  e._readableStreamController[C](t).then(function() {}))
				);
			}
			function Ct(e) {
				e._state = 'closed';
				...
				void 0 !== r &&
					(M(r)
						? (r._readRequests.forEach(function(e) {
						  ...
						  (r._readRequests = new g()))
						: (r._readIntoRequests.forEach(function(e) {
								e._reject(t);
						  }),
						  (r._readIntoRequests = new g())),
					k(r, t));
			}
			function Rt(e) {
			...
			'symbol' == typeof n.asyncIterator &&
				Object.defineProperty(_t.prototype, n.asyncIterator, {
					value: _t.prototype.getIterator,
					enumerable: !1,
					writable: !0,
					configurable: !0,
				});
				...
				Lt = (function() {
					function e(e, t, r) {
						...
						var n = t.size,
							...
							a = r.size,
							o = r.highWaterMark;
						if (void 0 !== e.writableType)
							throw new RangeError(
								'Invalid writable type specified',
							);
						var s = v(n);
						if (
							(void 0 === i && (i = 1),
							(i = p(i)),
							void 0 !== e.readableType)
						)
							throw new RangeError(
								'Invalid readable type specified',
							);
						var u,
							c = v(a);
						void 0 === o && (o = 0),
							...
							(function(e, t, r, n, i, a) {
								...
								(e._writable = (function(e, t, r, n, i, a) {
									void 0 === i && (i = 1),
										void 0 === a &&
											(a = function() {
												return 1;
											});
									var o = Object.create(V.prototype);
									return (
										K(o),
										pe(
											o,
											Object.create(de.prototype),
											e,
											t,
											r,
											n,
									...
									function(t) {
										return (function(e, t) {
											...
											if (!0 === e._backpressure) {
												return e._backpressureChangePromise.then(
													function() {
														var n = e._writable;
														if (
															'erroring' ===
					...
					return (
						Object.defineProperty(e.prototype, 'readable', {
							get: function() {
								if (!1 === Ft(this)) throw zt('readable');
						...
						Object.defineProperty(e.prototype, 'writable', {
							get: function() {
								if (!1 === Ft(this)) throw zt('writable');
			...
			function It(e, t) {
				We(e._readable._readableStreamController, t), jt(e, t);
			}
			function jt(e, t) {
				qt(e._transformStreamController),
					ye(e._writable._writableStreamController, t),
					!0 === e._backpressure && Mt(e, !1);
			}
			function Mt(e, t) {
			...
			var Nt = (function() {
				...
				return (
					Object.defineProperty(e.prototype, 'desiredSize', {
						get: function() {
							if (!1 === Dt(this)) throw Bt('desiredSize');
							return Be(
					...
					(e.prototype.enqueue = function(e) {
						if (!1 === Dt(this)) throw Bt('enqueue');
						Ut(this, e);
					}),
					(e.prototype.error = function(e) {
						if (!1 === Dt(this)) throw Bt('error');
						var t;
						(t = e), It(this._controlledTransformStream, t);
					}),
					(e.prototype.terminate = function() {
						if (!1 === Dt(this)) throw Bt('terminate');
						!(function(e) {
			...
			function Ut(e, t) {
				...
				try {
					...
					throw (jt(r, e), r._readable._storedError);
				}
				(function(e) {
					return !0 !== Ne(e);
				})(n) !== r._backpressure && Mt(r, !0);
			}
			function Wt(e, t) {
				return e._transformAlgorithm(t).catch(function(t) {
					throw (It(e._controlledTransformStream, t), t);
				});
			}
			function Bt(e) {
				return new TypeError(
		...
		function(e, t, r) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.getDocument = function(e) {
					...
					else if ((0, i.isArrayBuffer)(e)) t = { data: e };
					else if (e instanceof F) t = { range: e };
					else {
						if ('object' !== S(e))
							throw new Error(
						...
						if ('url' !== c || 'undefined' == typeof window)
							if ('range' !== c)
								if ('worker' !== c)
									if (
										'data' !== c ||
										t[c] instanceof Uint8Array
									)
										n[c] = t[c];
									else {
										var f = t[c];
										if ('string' == typeof f)
											n[c] = (0, i.stringToBytes)(f);
										else if (
											'object' !== S(f) ||
											null === f ||
											isNaN(f.length)
										) {
											if (!(0, i.isArrayBuffer)(f))
												throw new Error(
													'Invalid PDF binary data: either typed array, string or array-like object is expected in the data property.',
												);
											n[c] = new Uint8Array(f);
										} else n[c] = new Uint8Array(f);
									}
								else u = t[c];
							else o = t[c];
					...
					return (
						u.promise
							.then(function() {
								...
								return (function(e, t, r, n) {
								...
								})(u, n, o, g).then(function(e) {
									if (r.destroyed)
										throw new Error('Loading aborted');
									var t;
									o
										? (t = new d.PDFDataTransportStream(
												{
													length: n.length,
									...
									var i = new h.MessageHandler(g, e, u.port);
									i.postMessageTransfers =
										u.postMessageTransfers;
									var a = new q(i, r, t, n);
			...
			if (
				...
				E &&
					(w = E.replace(/(\.(?:min\.)?js)(\?.*)?$/i, '.worker$1$2'));
			}
			var O,
				L = ((O = 0),
				(function() {
					...
					A(e, [
						...
						},
						{
							...
							value: function(e) {
								...
								(this.pendingCleanup = !1),
									this.intentStates[S] ||
										(this.intentStates[S] = Object.create(
											null,
										));
								var w = this.intentStates[S];
								w.streamReaderCancelTimeout &&
									(clearTimeout(w.streamReaderCancelTimeout),
									(w.streamReaderCancelTimeout = null));
								var k = y || new a.DOMCanvasFactory(),
									x = new p.WebGLContext({ enable: c });
								w.displayReadyCapability ||
									((w.displayReadyCapability = (0,
									i.createPromiseCapability)()),
									(w.operatorList = {
										fnArray: [],
										argsArray: [],
								...
								var C = function(e) {
										var r = w.renderTasks.indexOf(P);
										r >= 0 && w.renderTasks.splice(r, 1),
								...
								w.renderTasks || (w.renderTasks = []),
									w.renderTasks.push(P);
								var R = P.task;
								return (
						...
						},
						{
							...
							value: function() {
								this.intentStates.oplist ||
									(this.intentStates.oplist = Object.create(
										null,
									));
								var e,
									...
									t.opListReadCapability ||
										(((e = {}).operatorListChanged = function() {
											if (t.operatorList.lastChunk) {
												t.opListReadCapability.resolve(
													t.operatorList,
												);
												var r = t.renderTasks.indexOf(
													e,
												);
												r >= 0 &&
													t.renderTasks.splice(r, 1);
											}
										}),
						...
						},
						{
							...
							value: function() {
								...
								var t = [];
								return (
									Object.keys(this.intentStates).forEach(
										function(r) {
											...
											e._abortOperatorList({
												...
												'oplist' !== r &&
													n.renderTasks.forEach(
														function(e) {
															var r = e.capability.promise.catch(
																function() {},
															);
															t.push(r),
																e.cancel();
							...
							value: function() {
								var e = this,
									t =
										...
										arguments[0];
								this.pendingCleanup &&
									!Object.keys(this.intentStates).some(
										function(t) {
											var r = e.intentStates[t];
											return (
												0 !== r.renderTasks.length ||
										...
										function(e) {
											if (
												...
												if (n.displayReadyCapability)
													n.displayReadyCapability.reject(
														e,
													);
												else {
													if (!n.opListReadCapability)
														throw e;
													n.opListReadCapability.reject(
														e,
													);
												}
											}
							...
							value: function(e) {
								...
								if (
									...
									r.streamReader.cancel(
										new i.AbortException(n && n.message),
									),
										(r.streamReader = null),
						...
						},
						{
							key: 'stats',
							get: function() {
								return this._stats instanceof a.StatTimer
									? this._stats
									: null;
							},
						},
			...
			var N = (function() {
				...
				function n() {
					if (l.GlobalWorkerOptions.workerSrc)
						return l.GlobalWorkerOptions.workerSrc;
				...
				return (function() {
					function s() {
						var e =
							...
							o = void 0 === a ? null : a,
							u = e.verbosity,
							c = void 0 === u ? (0, i.getVerbosityLevel)() : u;
						...
						if (
							...
							return (
								t.set(o, this), void this._initializeFromPort(o)
							);
						this._initialize();
					}
					return (
											...
											(function() {
												...
												.then(function(e) {
													if (t.destroyed)
														...
														t._port = n;
														var i = 'fake' + r++,
															a = new h.MessageHandler(
																i + '_worker',
																i,
																n,
															);
														e.setup(a, n);
														var o = new h.MessageHandler(
															i,
															i + '_worker',
															n,
														);
							...
							},
							{
								...
								value: function() {
									...
									t.on('GetReader', function(t, r) {
										(0, i.assert)(e._networkStream),
											(e._fullReader = e._networkStream.getFullReader()),
											(e._fullReader.onProgress = function(
												t,
											) {
												e._lastProgress = {
													loaded: t.loaded,
										...
										t.on('PasswordRequest', function(t) {
											if (
												...
												try {
													...
													e._passwordCapability.reject(
														t,
													);
												}
											} else e._passwordCapability.reject(new i.PasswordException(t.message, t.code));
											return e
												._passwordCapability.promise;
										}),
										t.on('PasswordException', function(e) {
											r._capability.reject(
												new i.PasswordException(
													e.message,
													e.code,
												),
											);
										...
										t.on('DataLoaded', function(t) {
											r.onProgress &&
												...
												e.downloadInfoCapability.resolve(
													t,
												);
										}),
															...
															l.pdfBug &&
																...
																(f = {
																	registerFont: function(
																		...
																		c.default.FontInspector.fontAdded(
																			e,
																			t,
																		);
																	},
																});
															var d = new o.FontFaceObject(
																u,
																{
																	isEvalSupported:
																		l.isEvalSupported,
										...
										t.on('FetchBuiltInCMap', function(
											t,
											r,
										) {
											if (e.destroyed)
					...
					return (
						A(e, [
							...
							},
							{
								key: 'promise',
								get: function() {
									return this._internalRenderTask.capability
										.promise;
								},
							},
						]),
						...
						A(e, [
							{
								...
								value: function() {
									...
									if (!this.cancelled) {
										...
										this._pdfBug &&
											c.default.StepperManager &&
											c.default.StepperManager.enabled &&
											((this.stepper = c.default.StepperManager.create(
												this.pageNumber - 1,
											)),
											this.stepper.init(
												this.operatorList,
							...
							},
							{
								...
								value: function() {
									...
									(this.running = !1),
										...
										this._canvas && D.delete(this._canvas),
										this.callback(
											e ||
							...
							{
								key: '_next',
								value: ((t = n.default.mark(function e() {
		...
		function(e, t, r) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.addLinkAttributes = function(e) {
					...
					var c = Object.values(S).includes(n) ? n : S.NONE;
					(e.target = w[c]), (e.rel = 'string' == typeof i ? i : v);
				}),
					...
					return new Promise(function(t, r) {
						...
						(n.src = e),
							...
							(n.onerror = function() {
								r(
									new Error(
										'Cannot load script at: '.concat(n.src),
									),
								);
							}),
							(
			...
			var n,
				i = (n = r(180)) && n.__esModule ? n : { default: n },
				a = r(1);
			function o(e) {
				return (o =
					'function' == typeof Symbol &&
			...
			var v = 'noopener noreferrer nofollow';
			t.DEFAULT_LINK_REL = v;
			...
			var _ = (function() {
				function e(t) {
					...
					l && ((p = -p), (v = -v)),
						0 === h
							? ((g = Math.abs(A - r[1]) * n + o),
							  (m = Math.abs(_ - r[0]) * n + u),
							  (y = Math.abs(r[3] - r[1]) * n),
							  (b = Math.abs(r[2] - r[0]) * n))
							: ((g = Math.abs(_ - r[0]) * n + o),
							  (m = Math.abs(A - r[1]) * n + u),
				...
				return (
					p(e, [
						...
						},
						{
							...
							value: function(e) {
								var t = a.Util.applyTransform(
										[e[0], e[1]],
										this.transform,
									),
									r = a.Util.applyTransform(
										[e[2], e[3]],
										this.transform,
									);
						...
						},
						{
							...
							value: function(e, t) {
								return a.Util.applyInverseTransform(
									[e, t],
									this.transform,
								);
							},
			...
			var A = (function(e) {
				function t(e, r) {
					...
					return (
						f(this, t),
						((n = s(this, u(t).call(this, e))).type = r),
						n
					);
				}
				return (
			...
			t.RenderingCancelledException = A;
			var S = { NONE: 0, SELF: 1, BLANK: 2, PARENT: 3, TOP: 4 };
			t.LinkTarget = S;
			var w = ['', '_self', '_blank', '_parent', '_top'];
			var k = (function() {
				function e() {
					var t =
						!(arguments.length > 0 && void 0 !== arguments[0]) ||
			...
			var x,
				C = (function() {
					function e() {
						f(this, e),
							(0, a.unreachable)(
								'Cannot initialize DummyStatTimer.',
							);
					}
					return (
						p(e, null, [
				...
				v = (function() {
					...
					return (
						d(e, [
								...
								value: function(e) {
									...
									t ||
										(((t = this.styleElement = document.createElement(
											'style',
										)).id = 'PDFJS_FONT_STYLE_TAG_'.concat(
											this.docId,
										)),
							...
							{
								key: 'bind',
								value: ((t = i.default.mark(function e(t) {
									var r,
										n,
										o = this;
									return i.default.wrap(
												...
												switch ((e.prev = e.next)) {
													...
													case 24:
														return e.abrupt(
															...
															new Promise(
																function(e) {
																	var r = o._queueLoadingCallback(
																		e,
																	);
																	o._prepareFontLoadEvent(
																		[n],
																		[t],
																		r,
																	);
							...
							},
							{
								...
								value: function(e, t, r) {
									...
									var h = 'lt'
										...
										d = n((f = i(f, 976, h.length, h)), 16);
									for (o = 0, s = h.length - 3; o < s; o += 4)
										d = (d - 1482184792 + n(h, o)) | 0;
									o < h.length &&
										(d =
											(d - 1482184792 + n(h + 'XXX', o)) |
											0),
										(f = i(f, 16, 4, (0, a.string32)(d)));
								...
								value: function(e, t) {
									...
									try {
										...
										return (
											...
											(this.compiledGlyphs[t] = function(
												e,
												t,
											) {})
										);
									}
									if (this.isEvalSupported && g.value) {
										for (
											var i, o = '', s = 0, u = r.length;
											s < u;
											s++
										)
											(i =
										...
										return (this.compiledGlyphs[
											t
										] = new Function('c', 'size', o));
									}
									return (this.compiledGlyphs[t] = function(
										e,
										t,
									) {
										for (
				...
				l = (function() {
					...
					function t(e, t) {
						if (
							...
							if (t.kind === n.ImageKind.GRAYSCALE_1BPP) {
								...
								for (s = 0, c = h * a * 4, i = 0; i < d; i++)
									y.set(m.subarray(g, g + c)),
										(g += c),
								...
								if (t.kind !== n.ImageKind.RGB_24BPP)
									throw new Error(
										'bad image kind: '.concat(t.kind),
									);
								for (c = h * (u = a), i = 0; i < p; i++) {
									for (
										i >= d && (c = h * (u = f)),
											r = 0,
											s = c;
					...
					function v(e, t, r, n) {
						...
						!(function(e, t, r, n, i, a, o) {
							...
							s = 'Luminosity' === i ? p : d;
							for (
								var v = Math.min(n, Math.ceil(1048576 / r)),
									g = 0;
								g < n;
								g += v
							) {
								var m = Math.min(v, n - g),
									y = e.getImageData(0, g, r, m),
									b = t.getImageData(0, g, r, m);
								u && f(y.data, c, l, h),
									s(y.data, b.data, o),
									e.putImageData(b, 0, g);
							}
						})(
							a,
							r,
					...
					for (var _ in ((e.prototype = {
						...
						executeOperatorList: function(e, t, r, i) {
							...
							for (
								...
								if ((c = o[s]) !== n.OPS.dependency)
									this[c].apply(this, a[s]);
								else {
									var v = !0,
										g = !1,
										m = void 0;
						...
						stroke: function(e) {
							...
							if (
								...
								var i = t.mozCurrentTransform,
									a = n.Util.singularValueDecompose2dScale(
										i,
									)[0];
						...
						paintChar: function(e, t, r, i) {
							var a,
								...
								h = c & n.TextRenderingMode.FILL_STROKE_MASK,
								f = !!(
									c & n.TextRenderingMode.ADD_TO_PATH_FLAG
								),
							...
							if (
								...
								for (
									...
									if (((r = e[t]), (0, n.isNum)(r)))
										...
										var m = (r.isSpace ? d : 0) + f,
											y =
												u.charProcOperatorList[
													r.operatorListId
												];
										if (y)
						...
						shadingFill: function(e) {
							...
							if (a) {
								var o = t.canvas,
									...
									l = n.Util.applyTransform([0, u], a),
									h = n.Util.applyTransform([s, 0], a),
									f = n.Util.applyTransform([s, u], a),
						...
						beginGroup: function(e) {
							...
							var o = Math.floor(i[0]),
								...
								c = Math.max(Math.ceil(i[3]) - s, 1),
								h = 1,
								f = 1;
							u > 4096 && ((h = u / 4096), (u = 4096)),
								c > 4096 && ((f = c / 4096), (c = 4096));
							var d = 'groupAt' + this.groupLevel;
							e.smask &&
								(d += '_smask_' + (this.smaskCounter++ % 2));
							var p = this.cachedCanvases.getCanvas(d, u, c, !0),
								v = p.context;
							v.scale(1 / h, 1 / f),
								v.translate(-o, -s),
						...
						paintImageMaskXObject: function(e) {
							...
							if (
								...
								var u = this.cachedCanvases.getCanvas(
										'maskCanvas',
										n,
										i,
									),
						...
						paintImageMaskXObjectGroup: function(e) {
							for (
								...
								var s = e[a],
									u = s.width,
									c = s.height,
									l = this.cachedCanvases.getCanvas(
										'maskCanvas',
										u,
										c,
									),
						...
						paintInlineImageXObject: function(e) {
							...
							if (
								...
								var p = (o = this.cachedCanvases.getCanvas(
									'inlineImage',
									r,
									n,
								)).context;
							...
							for (
								...
								l > 2 &&
									...
									d > 2 &&
										g > 1 &&
										(d /= g / (b = Math.ceil(g / 2))),
									(p = (o = this.cachedCanvases.getCanvas(
										m,
										y,
										b,
						...
						paintInlineImageXObjectGroup: function(e, r) {
							...
							for (var s = 0, u = r.length; s < u; s++) {
								...
								if (
									...
									var l = this.getCanvasPosition(c.x, c.y);
									this.imageLayer.appendImage({
										imgData: e,
										left: l[0],
										top: l[1],
			...
			var o = (function() {
				...
				return function(e, r, n, i, a, o, s, u) {
					var c,
						...
						v = Math.ceil(e[2]) - d,
						g = Math.ceil(e[3]) - p,
						m = Math.min(Math.ceil(Math.abs(v * r[0] * 1.1)), 3e3),
						y = Math.min(Math.ceil(Math.abs(g * r[1] * 1.1)), 3e3),
						b = v / m,
						_ = g / y,
						A = {
							coords: n,
					...
					if (u.isEnabled)
						(c = u.drawFigures({
							...
							(l = s.getCanvas(
								...
								w,
								!1,
							)).context.drawImage(c, 2, 2),
							(c = l.canvas);
					else {
						var k = (l = s.getCanvas('mesh', S, w, !1)).context,
							x = k.createImageData(m, y);
						if (o) {
							var C = x.data;
							for (h = 0, f = C.length; h < f; h += 4)
								(C[h] = o[0]),
									(C[h + 1] = o[1]),
									(C[h + 2] = o[2]),
									(C[h + 3] = 255);
						...
						k.putImageData(x, 2, 2), (c = l.canvas);
					}
					return {
						canvas: c,
						offsetX: d - 2 * b,
				...
				fromIR: function(e) {
					...
					return {
						...
						getPattern: function(e, h, f) {
							var d;
							if ((a(e, c), f))
								d = n.Util.singularValueDecompose2dScale(
									e.mozCurrentTransform,
								);
							else if (
								((d = n.Util.singularValueDecompose2dScale(
								...
								var p = n.Util.singularValueDecompose2dScale(u);
								d = [d[0] * p[0], d[1] * p[1]];
							}
							var v = o(
								s,
					...
					(r.prototype = {
						createPatternCanvas: function(e) {
							...
							var l = r[0],
								...
								f = r[2],
								d = r[3],
								p = n.Util.singularValueDecompose2dScale(
									this.matrix,
								),
								v = n.Util.singularValueDecompose2dScale(
									this.baseTransform,
								),
								g = [p[0] * v[0], p[1] * v[1]],
		...
		function(e, t, r) {
					...
					if (t.targetName === n.sourceName)
						if (t.stream) n._processStreamMessage(t);
							...
							if (!(t.callbackId in i))
								throw new Error(
									'Cannot resolve callback '.concat(o),
								);
							var s = i[o];
							delete i[o],
								'reason' in t
							...
							if (t.callbackId) {
								...
								t.streamId ? n._createStreamSink(t) : u(t.data);
						}
				}),
			...
			p.prototype = {
				...
				sendWithStream: function(e, t, r, i) {
					var o = this,
						s = this.streamId++,
						u = this.sourceName,
						c = this.targetName,
						h = this.comObj;
					return new n.ReadableStream(
						{
							start: function(r) {
								var a = (0, n.createPromiseCapability)();
								return (
									(o.streamControllers[s] = {
										controller: r,
										startCall: a,
										pullCall: null,
										cancelCall: null,
							...
							pull: function(e) {
								...
								return (
									(o.streamControllers[s].pullCall = t),
									h.postMessage({
										sourceName: u,
										targetName: c,
										stream: l,
							...
							cancel: function(e) {
								...
								var t = (0, n.createPromiseCapability)();
								return (
									(o.streamControllers[s].cancelCall = t),
									(o.streamControllers[s].isClosed = !0),
									h.postMessage({
										sourceName: u,
										targetName: c,
										stream: a,
				...
				_processStreamMessage: function(e) {
					var t = this,
						...
						g = function() {
							Promise.all(
								[
									t.streamControllers[p].startCall,
									t.streamControllers[p].pullCall,
									t.streamControllers[p].cancelCall,
								].map(function(e) {
									return e && e.promise.catch(function() {});
								}),
							).then(function() {
								delete t.streamControllers[p];
							});
						};
					switch (e.stream) {
						case f:
							e.success
								? this.streamControllers[p].startCall.resolve()
								: this.streamControllers[p].startCall.reject(
										d(e.reason),
								  );
							break;
						case h:
							e.success
								? this.streamControllers[p].pullCall.resolve()
								: this.streamControllers[p].pullCall.reject(
										d(e.reason),
								  );
							break;
						case l:
							...
							this.streamSinks[p].desiredSize <= 0 &&
								e.desiredSize > 0 &&
								this.streamSinks[p].sinkCapability.resolve(),
								(this.streamSinks[p].desiredSize =
									e.desiredSize);
							var m = this.streamSinks[e.streamId].onPull;
							new Promise(function(e) {
								e(m && m());
							}).then(
								function() {
						...
						case u:
							if (
								...
								this.streamControllers[p].isClosed)
							)
								break;
							this.streamControllers[p].controller.enqueue(
								e.chunk,
							);
							break;
						case s:
							...
							(this.streamControllers[p].isClosed = !0),
								this.streamControllers[p].controller.close(),
								g();
							break;
						case c:
							(0, n.assert)(
								...
								this.streamControllers[p].controller.error(
									d(e.reason),
								),
								g();
							break;
						case o:
							e.success
								? this.streamControllers[p].cancelCall.resolve()
								: this.streamControllers[p].cancelCall.reject(
										d(e.reason),
								  ),
								g();
							break;
						case a:
							if (!this.streamSinks[p]) break;
							var y = this.streamSinks[e.streamId].onCancel;
							new Promise(function(t) {
								t(y && y(d(e.reason)));
							}).then(
								function() {
								...
								this.streamSinks[p].sinkCapability.reject(
									d(e.reason),
								),
								(this.streamSinks[p].isCancelled = !0),
								delete this.streamSinks[p];
							break;
						default:
							...
							value: function(e) {
								...
								if ('rdf:rdf' !== t.nodeName.toLowerCase())
									for (
										t = t.firstChild;
										t &&
										'rdf:rdf' !== t.nodeName.toLowerCase();
								...
								value: function(e) {
									...
									return e.replace(/&([^;]+);/g, function(
										...
										if ('#x' === r.substring(0, 2))
											return String.fromCharCode(
												parseInt(r.substring(2), 16),
											);
										if ('#' === r.substring(0, 1))
											return String.fromCharCode(
												parseInt(r.substring(1), 10),
											);
										switch (r) {
											case 'lt':
												return '<';
									...
									for (var t = 0; t < e.length; ) {
										...
										if ('<' === e[t]) {
											...
											switch (e[++r]) {
												...
												case '?':
													++r;
													var i = this._parseProcessingInstruction(
														e,
														r,
													);
													if (
														...
														return void this.onError(
															f.UnterminatedXmlDeclaration,
														);
													this.onPi(i.name, i.value),
														(r += i.parsed + 2);
													break;
												case '!':
													if (
														...
														if (
															...
															return void this.onError(
																f.UnterminatedDoctypeDeclaration,
															);
														if (a > 0 && n > a) {
															if (
																(n = e.indexOf(
					...
					return (
						h(e, [
							...
							},
							{
								...
								get: function() {
									return (
										this.childNodes && this.childNodes[0]
									);
								},
							},
							{
					...
					l(e, [
						{
							...
							value: function(e) {
								...
								if (void 0 === e.begin)
									...
									var r = this._rangeReaders.some(function(
										r,
									) {
										return (
											r._begin === e.begin &&
			...
			var f = (function() {
					function e(t, r) {
						...
						try {
							for (
								var s,
									c = this._queuedChunks[Symbol.iterator]();
								!(i = (s = c.next()).done);
								i = !0
							) {
								var l = s.value;
									...
									if (!this._done) {
										if (0 === this._requests.length)
											...
											this._requests
												...
												this._requests.forEach(function(
													e,
												) {
													e.resolve({
														value: void 0,
			...
			var o = (function() {
				function e(e, t, r) {
					...
					if (
						...
						throw new Error(
							'Error during shader compilation: ' + i,
						);
					}
					return n;
				}
				...
				function n(e, t) {
					for (
						var r = e.createProgram(), n = 0, i = t.length;
						n < i;
						++n
					)
				...
				return {
					...
					composeSMask: function(e, h, f) {
						...
						l ||
							(function() {
								...
								var h = n(i, [t(i, u), r(i, c)]);
								i.useProgram(h);
								var f = {};
								(f.gl = i),
									(f.canvas = e),
									(f.resolutionLocation = i.getUniformLocation(
										h,
										'u_resolution',
									)),
									(f.positionLocation = i.getAttribLocation(
										h,
										'a_position',
									)),
									(f.backdropLocation = i.getUniformLocation(
										h,
										'u_backdrop',
									)),
									(f.subtypeLocation = i.getUniformLocation(
										h,
										'u_subtype',
									));
								var d = i.getAttribLocation(h, 'a_texCoord'),
						...
						(g.width = d),
							...
							m.uniform2f(v.resolutionLocation, d, p),
							f.backdrop
								? m.uniform4f(
								...
								: m.uniform4f(v.resolutionLocation, 0, 0, 0, 0),
							m.uniform1i(
								v.subtypeLocation,
								'Luminosity' === f.subtype ? 1 : 0,
							);
						var y = i(m, e, m.TEXTURE0),
							b = i(m, h, m.TEXTURE1),
							_ = m.createBuffer();
						return (
							...
							m.enableVertexAttribArray(v.positionLocation),
					...
					drawFigures: function(e, i, u, c, l) {
						d ||
							(function() {
								var e, i;
								s(), (e = o), (o = null), (i = a), (a = null);
								var u = n(i, [t(i, h), r(i, f)]);
								i.useProgram(u);
								var c = {};
								(c.gl = i),
									(c.canvas = e),
									(c.resolutionLocation = i.getUniformLocation(
										u,
										'u_resolution',
									)),
									(c.scaleLocation = i.getUniformLocation(
										u,
										'u_scale',
									)),
									(c.offsetLocation = i.getUniformLocation(
										u,
										'u_offset',
									)),
									(c.positionLocation = i.getAttribLocation(
										u,
										'a_position',
									)),
									(c.colorLocation = i.getAttribLocation(
										u,
										'a_color',
									)),
									(d = c);
						...
						(v.width = e),
							...
							g.uniform2f(p.resolutionLocation, e, i);
						var m,
							y,
							b,
							_ = 0;
						...
						g.bindBuffer(g.ARRAY_BUFFER, M),
							...
							g.enableVertexAttribArray(p.positionLocation),
						...
						return (
							...
							g.bufferData(g.ARRAY_BUFFER, S, g.STATIC_DRAW),
							g.enableVertexAttribArray(p.colorLocation),
							g.vertexAttribPointer(
								p.colorLocation,
								3,
								g.UNSIGNED_BYTE,
							...
							g.uniform2f(p.scaleLocation, l.scaleX, l.scaleY),
							g.uniform2f(p.offsetLocation, l.offsetX, l.offsetY),
							g.drawArrays(g.TRIANGLES, 0, _),
							g.flush(),
							g.deleteBuffer(M),
							g.deleteBuffer(N),
							v
		...
		function(e, t, r) {
			...
			var o = (function() {
				...
				function r(e, r, n) {
					...
					if ((e._textDivs.push(o), (a = r.str), !t.test(a)))
						return (
							(s.isWhitespace = !0),
							void e._textDivProperties.set(o, s)
						);
					var u = i.Util.transform(
							e._viewport.transform,
							r.transform,
						),
						c = Math.atan2(u[1], u[0]),
						l = n[r.fontName];
					l.vertical && (c += Math.PI / 2);
					var h,
						f,
						d = Math.sqrt(u[2] * u[2] + u[3] * u[3]),
						p = d;
					if (
						(l.ascent
							? (p = l.ascent * p)
							: l.descent && (p = (1 + l.descent) * p),
						0 === c
							? ((h = u[4]), (f = u[5] - p))
							: ((h = u[4] + p * Math.sin(c)),
							  (f = u[5] - p * Math.cos(c))),
						(o.style.left = ''.concat(h, 'px')),
						(o.style.top = ''.concat(f, 'px')),
						(o.style.fontSize = ''.concat(d, 'px')),
						(o.style.fontFamily = l.fontFamily),
						(o.textContent = r.str),
						e._fontInspectorEnabled &&
							(o.dataset.fontName = r.fontName),
						0 !== c && (s.angle = c * (180 / Math.PI)),
						r.str.length > 1 &&
							(l.vertical
								? (s.canvasWidth = r.height * e._viewport.scale)
								: (s.canvasWidth =
										r.width * e._viewport.scale)),
						e._textDivProperties.set(o, s),
						e._textContentStream && e._layoutText(o),
						e._enhanceTextSelection)
					) {
						var v = 1,
							g = 0;
						0 !== c && ((v = Math.cos(c)), (g = Math.sin(c)));
						var m,
							y,
							b =
								(l.vertical ? r.height : r.width) *
								e._viewport.scale,
							_ = d;
						0 !== c
							? ((m = [v, g, -g, v, h, f]),
							  (y = i.Util.getAxialAlignedBoundingBox(
									[0, 0, b, _],
									m,
							  )))
							: (y = [h, f, h + b, f + _]),
				...
				function n(t) {
					if (!t._canceled) {
						var r = t._textDivs,
							...
							i = r.length;
						if (i > e)
							return (t._renderingDone = !0), void n.resolve();
				...
				function s(e, t) {
					...
					t.forEach(function(e) {
						...
						var l = [],
							h = null;
						for (o = t; o <= a; o++) {
							var f = (i = (n = r[o]).boundary).x2 > e.x2 ? i : e;
							h === f
								? (l[l.length - 1].end = n.end)
								: (l.push({
										start: n.start,
										end: n.end,
										boundary: f,
						...
						for (
							...
							if (void 0 === (i = (n = r[o]).boundary).x2New) {
								...
								for (
									s = t - 1;
									!d && s >= 0 && r[s].start >= i.y1;
									s--
								)
									d = r[s].boundary === i;
								for (
									s = a + 1;
									!d && s < r.length && r[s].end <= i.y2;
									s++
								)
									d = r[s].boundary === i;
								for (s = 0; !d && s < l.length; s++)
									d = l[s].boundary === i;
								d || (i.x2New = u);
							}
					...
					(u.prototype = {
						...
						_render: function(e) {
							...
							if (
								...
								(this._reader = this._textContentStream.getReader()),
									(function e() {
										t._reader.read().then(function(n) {
											var i = n.value;
											n.done
												? r.resolve()
						...
						expandTextDivs: function(e) {
							if (
								...
								null !== this._bounds &&
									(o(this), (this._bounds = null));
								for (
									var t = [],
										r = [],
										n = 0,
										i = this._textDivs.length;
									n < i;
									n++
								) {
									var a = this._textDivs[n],
										s = this._textDivProperties.get(a);
									if (!s.isWhitespace)
										if (e) {
											(t.length = 0),
												(r.length = 0),
												s.originalTransform &&
													t.push(s.originalTransform),
												s.paddingTop > 0
													? (r.push(
															''.concat(
																s.paddingTop,
			...
			var v = (function() {
								...
								value: function() {
									...
									if (
										...
										switch (t.borderStyle.style) {
											case i.AnnotationBorderStyleType
												.SOLID:
									...
									return (
										(a.style.left = ''.concat(u[0], 'px')),
										(a.style.top = ''.concat(u[1], 'px')),
				...
				m = (function(e) {
					function t(e) {
						...
						return s(this, c(t).call(this, e, r));
					}
					return (
						l(t, e),
						p(t, [
							...
							},
							{
								...
								value: function(e, t) {
									var r = this;
									(e.href = this.linkService.getDestinationHash(
										t,
									)),
										(e.onclick = function() {
											return (
												t &&
													r.linkService.navigateTo(t),
												!1
											);
										}),
							...
							},
							{
								...
								value: function(e, t) {
									...
									(e.href = this.linkService.getAnchorUrl(
										...
										(e.onclick = function() {
											return (
												r.linkService.executeNamedAction(
													t,
												),
												!1
											);
				...
				b = (function(e) {
					function t() {
						return f(this, t), s(this, c(t).apply(this, arguments));
					}
					return (
						l(t, e),
						p(t, [
									...
									if (this.renderInteractiveForms) {
										if (
											...
											e.classList.add('comb'),
												(e.style.letterSpacing = 'calc('.concat(
													t,
													'px - 1ch)',
												));
										}
										...
										this.data.fontRefName &&
											this.page.commonObjs.has(
												this.data.fontRefName,
											) &&
											(r = this.page.commonObjs.get(
												this.data.fontRefName,
											)),
				...
				A = (function(e) {
					function t(e) {
						return (
							...
							s(
								this,
								c(t).call(this, e, e.renderInteractiveForms),
							)
						);
					}
					return (
						...
						p(e, [
							{
								...
								value: function() {
									...
									(u.textContent = this.title),
										t.appendChild(u);
									var c = n.PDFDateString.toDateObject(
										this.modificationDate,
									);
									if (c) {
										var l = document.createElement('span');
										(l.textContent = '{{date}}, {{time}}'),
											(l.dataset.l10nId =
												'annotation_date_string'),
											(l.dataset.l10nArgs = JSON.stringify(
												{
							...
							},
							{
								...
								value: function() {
									var e =
										...
										arguments[0];
									e && (this.pinned = !0),
										this.hideElement.hasAttribute(
											'hidden',
										) &&
											(this.hideElement.removeAttribute(
												'hidden',
											),
				...
				P = (function(e) {
					function t(e) {
						...
						return s(this, c(t).call(this, e, r, !0));
					}
					return (
						l(t, e),
						p(t, [
						...
						p(t, [
							{
								...
								value: function() {
									...
									var e = this.data,
										...
										a = this.svgFactory.createElement(
											'svg:rect',
										);
									return (
						...
						p(t, [
							{
								...
								value: function() {
									...
									i = i.join(' ');
									var d = this.svgFactory.createElement(
										this.svgElementName,
									);
									return (
										d.setAttribute('points', i),
										d.setAttribute(
											'stroke-width',
											e.borderStyle.width,
										),
										...
										n.appendChild(d),
										this.container.append(n),
										this._createPopup(this.container, d, e),
										this.container
									);
								},
							},
								...
								value: function() {
									...
									try {
										for (
											...
											l = l.join(' ');
											var b = this.svgFactory.createElement(
												this.svgElementName,
											);
											b.setAttribute('points', l),
												b.setAttribute(
													'stroke-width',
													e.borderStyle.width,
												),
				...
				U = (function(e) {
					function t(e) {
						var r;
						f(this, t);
						var a = (r = s(this, c(t).call(this, e, !0))).data.file,
							o = a.filename,
							l = a.content;
						return (
							...
							r.linkService.eventBus &&
								r.linkService.eventBus.dispatch(
		...
		function(e, t, r) {
			...
			var n,
				i = r(1),
				a = r(183),
				o = (n = r(4)) && n.__esModule ? n : { default: n };
			function s(e) {
				return (
					(function(e) {
						if (Array.isArray(e)) {
			...
			var d = function(e) {
				...
				b = (function() {
					...
					function l(r, n, a, s) {
						...
						return (
							x.set(e, C),
							u('IHDR', S, x, (C += e.length)),
							u('IDATA', w, x, (C += t + S.length)),
							(C += t + w.length),
							u('IEND', new Uint8Array(0), x, C),
				...
				return (
					h(e, [
											...
											for (
												var l,
													h = function() {
														...
														t.current.dependencies.push(
															n,
														);
													},
													f = n[a][Symbol.iterator]();
												!(s = (l = f.next()).done);
												s = !0
											)
												h();
						...
						},
						{
							...
							value: function(e, t, r, n, i, a) {
								...
								(o.textMatrix = o.lineMatrix = [
									...
									(o.textMatrixScale = Math.sqrt(
										e * e + t * t,
									)),
									(o.x = o.lineX = 0),
									(o.y = o.lineY = 0),
									(o.xcoords = []),
									(o.tspan = this.svgFactory.createElement(
										'svg:tspan',
									)),
									...
									o.tspan.setAttributeNS(
										null,
										'font-size',
										''.concat(d(o.fontSize), 'px'),
									),
									o.tspan.setAttributeNS(null, 'y', d(-o.y)),
									(o.txtElement = this.svgFactory.createElement(
										'svg:text',
									)),
						...
						},
						{
							...
							value: function() {
								...
								(e.x = e.lineX = 0),
									...
									(e.txtElement = this.svgFactory.createElement(
										'svg:text',
									)),
									(e.txtgrp = this.svgFactory.createElement(
										'svg:g',
									)),
									(e.xcoords = []);
							},
							...
							value: function(e, t) {
								...
								(r.x = r.lineX += e),
									...
									r.tspan.setAttributeNS(
										null,
										'font-size',
										''.concat(d(r.fontSize), 'px'),
									),
									r.tspan.setAttributeNS(null, 'y', d(-r.y));
							},
						},
						{
							key: 'showText',
								...
								if (0 !== n) {
									...
									if (
										...
										k === i.TextRenderingMode.STROKE ||
											k ===
												i.TextRenderingMode.FILL_STROKE)
									) {
									...
									var C = t.textMatrix;
									0 !== t.textRise &&
										((C = C.slice())[5] += t.textRise),
										t.txtElement.setAttributeNS(
											null,
											'transform',
											''.concat(p(C), ' scale(1, -1)'),
										),
										t.txtElement.setAttributeNS(
						...
						},
						{
							...
							value: function(e) {
								...
								n < 0
									...
									t.tspan.setAttributeNS(null, 'y', d(-t.y)),
									(t.xcoords = []);
							},
						},
						{
						...
						},
						{
							...
							value: function(e, t, r) {
								this.current.strokeColor = i.Util.makeCssRgb(
									e,
									t,
									r,
								);
						...
						},
						{
							key: 'setFillRGBColor',
							value: function(e, t, r) {
								(this.current.fillColor = i.Util.makeCssRgb(
									e,
									t,
									r,
								)),
						...
						},
						{
							...
							value: function(e) {
								var t = this.viewport.width,
									...
									c = Math.min(a[0], o[0], s[0], u[0]),
									l = Math.min(a[1], o[1], s[1], u[1]),
									h = Math.max(a[0], o[0], s[0], u[0]),
									f = Math.max(a[1], o[1], s[1], u[1]),
									d = this.svgFactory.createElement(
										'svg:rect',
									);
								d.setAttributeNS(null, 'x', c),
									d.setAttributeNS(null, 'y', l),
									d.setAttributeNS(null, 'width', h - c),
									d.setAttributeNS(null, 'height', f - l),
									d.setAttributeNS(
										null,
										'fill',
										this._makeShadingPattern(e),
									),
									this._ensureTransformGroup().appendChild(d);
							},
						},
						{
						...
						},
						{
							...
							value: function(e) {
								var t = e[1],
									...
									p = e[7],
									v = 'shading'.concat(w++),
									g = u(i.Util.applyTransform([o, c], n), 2),
									m = g[0],
									y = g[1],
									b = u(i.Util.applyTransform([l, h], n), 2),
									_ = b[0],
									A = b[1],
									S = u(
										i.Util.singularValueDecompose2dScale(n),
										2,
									),
									k = f * S[0],
									x = d * S[1],
									C = this.svgFactory.createElement(
										'svg:pattern',
									);
								C.setAttributeNS(null, 'id', v),
									...
									C.setAttributeNS(null, 'x', ''.concat(m)),
									C.setAttributeNS(null, 'y', ''.concat(y));
								var P = this.svg,
									R = this.transformMatrix,
									T = this.current.fillColor,
									E = this.current.strokeColor,
									O = this.svgFactory.create(_ - m, A - y);
								if (
									((this.svg = O),
									(this.transformMatrix = n),
									2 === p)
								) {
									var L = i.Util.makeCssRgb.apply(
										i.Util,
										s(t),
									);
									(this.current.fillColor = L),
										(this.current.strokeColor = L);
								}
								return (
									...
									case 'RadialAxial':
										...
										try {
											for (
												...
												var g = p.value,
													m = this.svgFactory.createElement(
														'svg:stop',
													);
												m.setAttributeNS(
													null,
						...
						},
						{
							...
							value: function(e, t) {
								...
								(o = o.join(' ')),
									...
									e[0] !== i.OPS.moveTo
										? (o =
												r.path.getAttributeNS(
													null,
													'd',
												) + o)
										: ((r.path = this.svgFactory.createElement(
												'svg:path',
										  )),
										  this._ensureTransformGroup().appendChild(
												r.path,
								...
								if (((e.path = null), this.pendingClip))
									if (e.element) {
										var t = 'clippath'.concat(A++),
											r = this.svgFactory.createElement(
												'svg:clipPath',
											);
						...
						},
						{
							...
							value: function() {
								var e = this.svgFactory.createElement(
									'svg:rect',
								);
						...
						},
						{
							...
							value: function(e, t, r) {
								...
								i.setAttributeNS(g, 'xlink:href', n.src),
									i.setAttributeNS(null, 'width', d(t)),
									i.setAttributeNS(null, 'height', d(r)),
									i.setAttributeNS(null, 'x', '0'),
									i.setAttributeNS(null, 'y', d(-r)),
									i.setAttributeNS(
										null,
										'transform',
										'scale('
						...
						},
						{
							...
							value: function(e, t) {
								...
								a.setAttributeNS(null, 'x', '0'),
									...
									a.setAttributeNS(null, 'width', d(r)),
									a.setAttributeNS(null, 'height', d(n)),
									(this.current.element = a),
									this.clip('nonzero');
								var o = this.svgFactory.createElement(
									'svg:image',
								);
								o.setAttributeNS(g, 'xlink:href', i),
									o.setAttributeNS(null, 'x', '0'),
									o.setAttributeNS(null, 'y', d(-n)),
									o.setAttributeNS(
										null,
										'width',
										d(r) + 'px',
						...
						},
						{
							...
							value: function(e) {
								...
								var a = this.svgFactory.createElement(
									'svg:mask',
								);
								...
								o.setAttributeNS(null, 'x', '0'),
									...
									o.setAttributeNS(null, 'width', d(r)),
									o.setAttributeNS(null, 'height', d(n)),
							...
							value: function(e, t) {
								if (
									...
									i.setAttributeNS(null, 'x', t[0]),
										...
										i.setAttributeNS(null, 'width', d(r)),
										i.setAttributeNS(null, 'height', d(n)),
			...
			var C = (function(e) {
					function t(e) {
						...
						var n = function(t) {
							if (404 === t.statusCode) {
								...
								return (
									(r._storedError = n),
									void r._headersCapability.reject(n)
								);
							}
							r._headersCapability.resolve(),
								r._setReadableStream(t);
							var i = function(e) {
									return r._readableStream.headers[
										e.toLowerCase()
									];
								},
							...
							(r._isRangeSupported = u),
								...
								(r._filename = (0, o.extractFilenameFromHeader)(
									i,
								));
						};
						return (
							((r = u(this, c(t).call(this, e)))._request = null),
							'http:' === r._url.protocol
								? (r._request = y.request(
										x(r._url, e.httpHeaders),
										n,
								  ))
								: (r._request = b.request(
										x(r._url, e.httpHeaders),
										n,
								  )),
				...
				P = (function(e) {
					function t(e, r, n) {
						...
						((i = u(this, c(t).call(this, e)))._httpHeaders = {}),
						e.httpHeaders)) {
							var s = e.httpHeaders[o];
							void 0 !== s && (i._httpHeaders[o] = s);
						}
						i._httpHeaders.Range = 'bytes='
							.concat(r, '-')
							.concat(n - 1);
						var l = function(e) {
						...
						return (
							...
							'http:' === i._url.protocol
								? (i._request = y.request(
										x(i._url, i._httpHeaders),
										l,
								  ))
								: (i._request = b.request(
										x(i._url, i._httpHeaders),
										l,
								  )),
						...
						return (
							...
							m.lstat(n, function(e, t) {
								...
								(r._contentLength = t.size),
									r._setReadableStream(m.createReadStream(n)),
									r._headersCapability.resolve();
							}),
							r
						);
		...
		function(e, t, r) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				...
				(t.extractFilenameFromHeader = function(e) {
					...
					if (t) {
						var r = (0, i.getFilenameFromContentDispositionHeader)(
							t,
						);
						if (r.includes('%'))
							try {
		...
		function(e, t, r) {
			...
			Object.defineProperty(t, '__esModule', { value: !0 }),
				(t.getFilenameFromContentDispositionHeader = function(e) {
					var t = !0,
						r = o('filename\\*', 'i').exec(e);
					if (r) {
						var i = c((r = r[1]));
						return u((i = h((i = l((i = unescape(i)))))));
					}
					if (
						(r = (function(e) {
							var t,
							...
							},
							{
								...
								value: function(e) {
									...
									return (
										...
										(t.onprogress = this.onProgress.bind(
											this,
											r,
										)),
										(n.onHeadersReceived =
						...
						h(e, [
							{
								...
								value: function(e) {
									var t = this._rangeRequestReaders.indexOf(
										e,
									);
									t >= 0 &&
										this._rangeRequestReaders.splice(t, 1);
								},
							},
							{
								key: 'getFullReader',
							...
							},
							{
								...
								value: function(e, t) {
									...
									return (
										(r.onClosed = this._onRangeRequestReaderClosed.bind(
											this,
										)),
						...
						h(e, [
							{
								...
								value: function() {
									var e = this._fullRequestId,
										...
										n = (0,
										o.validateRangeRequestCapabilities)({
											getResponseHeader: r,
									...
									i && (this._isRangeSupported = !0),
										...
										(this._filename = (0,
										o.extractFilenameFromHeader)(r)),
										this._isRangeSupported &&
											this._manager.abortRequest(e),
							...
							},
							{
								...
								value: function(e) {
									var t = this._url,
										r = (0, o.createResponseStatusError)(
											e,
											t,
										);
									(this._storedError = r),
							...
							},
							{
								key: 'headersReady',
								get: function() {
									return this._headersReceivedCapability
										.promise;
								},
							},
						]),
			...
			var p = (function() {
					function e(t) {
						...
						c(this, e),
							...
							(this._filename = null);
						var n = t.source;
						for (var i in ((this._withCredentials =
							n.withCredentials || !1),
				...
				v = (function() {
					function e(t, r, n) {
						...
						c(this, e),
							...
							(this._loaded = 0);
						var s = t.source;
						for (var u in ((this._withCredentials =
							s.withCredentials || !1),
						(this._readCapability = (0,
						a.createPromiseCapability)()),
						...
						this._stream.httpHeaders)) {
							...
							void 0 !== l && this._headers.append(u, l);
						}
